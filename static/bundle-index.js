...
var fabRipple = new _ripple.MDCRipple(document.querySelector('.mdc-fab'));

var shopRipple = new _ripple.MDCRipple(document.querySelector('.shop-shop'));
var insightsRipple = new _ripple.MDCRipple(document.querySelector('.shop-insights'));
var aboutRipple = new _ripple.MDCRipple(document.querySelector('.shop-about'));
//
var hotdogCheckbox = new _checkbox.MDCCheckbox(document.querySelector('.hotdog-check'));
var hotdogFormField = new _formField.MDCFormField(document.querySelector('.hotdog-form'));
hotdogFormField.input = hotdogCheckbox;

var proteinCheckbox = new _checkbox.MDCCheckbox(document.querySelector('.protein-check'));
var protienFormField = new _formField.MDCFormField(document.querySelector('.protein-form'));
protienFormField.input = proteinCheckbox;

var tofuCheckbox = new _checkbox.MDCCheckbox(document.querySelector('.tofu-check'));
var tofuFormField = new _formField.MDCFormField(document.querySelector('.tofu-form'));
tofuFormField.input = proteinCheckbox;

//
var carrotcheckbox = new _checkbox.MDCCheckbox(document.querySelector('.carrot-check'));
var carrotformField = new _formField.MDCFormField(document.querySelector('.carrot-form'));
carrotformField.input = carrotcheckbox;

var anisecheckbox = new _checkbox.MDCCheckbox(document.querySelector('.spice-check'));
var aniseformField = new _formField.MDCFormField(document.querySelector('.spice-form'));
aniseformField.input = anisecheckbox;

var baguettescheckbox = new _checkbox.MDCCheckbox(document.querySelector('.baguettes-check'));
var baguettesformField = new _formField.MDCFormField(document.querySelector('.baguettes-form'));
baguettesformField.input = baguettescheckbox;

var muffinscheckbox = new _checkbox.MDCCheckbox(document.querySelector('.muffins-check'));
var muffinsformField = new _formField.MDCFormField(document.querySelector('.muffins-form'));
muffinsformField.input = muffinscheckbox;

var toastcheckbox = new _checkbox.MDCCheckbox(document.querySelector('.toast-check'));
var toastformField = new _formField.MDCFormField(document.querySelector('.toast-form'));
toastformField.input = toastcheckbox;

var steakcheckbox = new _checkbox.MDCCheckbox(document.querySelector('.steak-check'));
var steakformField = new _formField.MDCFormField(document.querySelector('.steak-form'));
steakformField.input = steakcheckbox;

var raspberriescheckbox = new _checkbox.MDCCheckbox(document.querySelector('.raspberries-check'));
var raspberriesformField = new _formField.MDCFormField(document.querySelector('.raspberries-form'));
raspberriesformField.input = raspberriescheckbox;

var blueberriescheckbox = new _checkbox.MDCCheckbox(document.querySelector('.blueberries-check'));
var blueberriesformField = new _formField.MDCFormField(document.querySelector('.blueberries-form'));
blueberriesformField.input = blueberriescheckbox;

var doughnutscheckbox = new _checkbox.MDCCheckbox(document.querySelector('.donuts-check'));
var doughnutsformField = new _formField.MDCFormField(document.querySelector('.donuts-form'));
doughnutsformField.input = doughnutscheckbox;

var pancakescheckbox = new _checkbox.MDCCheckbox(document.querySelector('.pancakes-check'));
var pancakesformField = new _formField.MDCFormField(document.querySelector('.pancakes-form'));
pancakesformField.input = pancakescheckbox;

var saladscheckbox = new _checkbox.MDCCheckbox(document.querySelector('.salads-check'));
var saladsformField = new _formField.MDCFormField(document.querySelector('.salads-form'));
saladsformField.input = saladscheckbox;

var orangescheckbox = new _checkbox.MDCCheckbox(document.querySelector('.oranges-check'));
var orangesformField = new _formField.MDCFormField(document.querySelector('.oranges-form'));
orangesformField.input = orangescheckbox;

var onionscheckbox = new _checkbox.MDCCheckbox(document.querySelector('.onions-check'));
var onionsformField = new _formField.MDCFormField(document.querySelector('.onions-form'));
onionsformField.input = onionscheckbox;

var roastBeefCheckbox = new _checkbox.MDCCheckbox(document.querySelector('.roast-beef-check'));
var roastBeefFormField = new _formField.MDCFormField(document.querySelector('.roast-beef-form'));
roastBeefFormField.input = roastBeefCheckbox;

var churrosCheckbox = new _checkbox.MDCCheckbox(document.querySelector('.churros-check'));
var churrosFormField = new _formField.MDCFormField(document.querySelector('.churros-form'));
churrosFormField.input = churrosCheckbox;

var chiliPeppersCheckbox = new _checkbox.MDCCheckbox(document.querySelector('.chili-peppers-check'));
var chiliPeppersFormField = new _formField.MDCFormField(document.querySelector('.chili-peppers-form'));
chiliPeppersFormField.input = chiliPeppersCheckbox;

var salmonCheckbox = new _checkbox.MDCCheckbox(document.querySelector('.salmon-check'));
var salmonFormField = new _formField.MDCFormField(document.querySelector('.salmon-form'));
salmonFormField.input = salmonCheckbox;

// const insightsShopRipple = new MDCRipple(document.querySelector('.insights-shop'));
// const insightsInsightsRipple = new MDCRipple(document.querySelector('.insights-insights'));
// const insightsAboutRipple = new MDCRipple(document.querySelector('.insights-about'));
